  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-ink">Assignments Management</h1>
          <p className="mt-1 text-sm text-ink-muted">Manage teacher-parent assignments and classes</p>
        </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
        {[
          { label: 'Total', count: assignments.length, color: 'bg-ivory0' },
                  ...
                  <tr key={assignment.id} className="hover:bg-ivory">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        ...
                        <div className="ml-3">
                          <div className="text-sm font-medium text-ink">{assignment.teacher.full_name}</div>
                          <div className="text-sm text-ink-muted">{assignment.teacher.email}</div>
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
        ...
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
          <div className="relative top-20 mx-auto p-5 border w-11/12 md:w-3/4 lg:w-1/2 shadow-lg rounded-md bg-white">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-lg font-bold text-ink">Assignment Details</h3>
              <button
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-sm text-ink">{selectedAssignment.teacher.full_name}</p>
                </div>
                <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-ink">Parent</label>
                  <p className="text-sm text-ink">{selectedAssignment.parent.full_name}</p>
                </div>
                <div>
                  <label className="block text-sm font-medium text-ink">Subjects</label>
                  <p className="text-sm text-ink">{selectedAssignment.teacher.subjects?.join(', ')}</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-ink">{selectedAssignment.total_hours}</p>
                </div>
              </div>
              ...
              {selectedAssignment.notes && (
                <div>
                  ...
                  <p className="text-sm text-ink">{selectedAssignment.notes}</p>
                </div>
              )}
            </div>
